...
She performs two or three slow, controlled repetitions with textbook technique and a full range of motion (about two seconds down, a brief pause at the bottom so the end position is clearly visible, then up). The clip begins and ends in the same starting position so it can loop seamlessly.
